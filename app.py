...
def retrieve_books():
    try:
        books = Book.query.order_by(Book.year_completed).all()
...
'''
    GET /books/id
        public endpoint
    returns status code 200 and json {"success": True, "book": book } where 
    book is an array containing only the matched book object,
        or appropriate status code indicating reason for failure
'''
...
'''
    GET /degrees/id
        public endpoint
    returns status code 200 and json {"success": True, "degree": degree } where 
    degree is an array containing only the matched degree object,
        or appropriate status code indicating reason for failure
'''
